...
public class AndroidWebServerActivity extends Activity
    ...
    private CamServer webServer = null;
    ...
    private boolean initWebServer() {
        ...
        if ( ipAddr != null ) {
            try{
                webServer = new CamServer(8080, this);
    ...
    private void resetMediaBuffer() {
        synchronized(AndroidWebServerActivity.this) {
    ...
    private CamServer.CommonGatewayInterface doQuery = new CamServer.CommonGatewayInterface () {
        @Override
